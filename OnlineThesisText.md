...
The effect of instrumental perturbations on the photon rate can then be written as
$$ (N_j+\delta N_j)(t, \lambda, \alpha, \beta) \propto f_j (A \circ \delta A(t,\lambda),\phi_j + \delta \phi_j(t,\lambda),\theta + \delta \theta (t,\lambda) , (x+\delta x)(t), (y+\delta y)(t), t, \lambda, \alpha, \beta) $$
